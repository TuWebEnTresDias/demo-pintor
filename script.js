...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const Personalization = {
        ...
        init() {
            ...
            const company = rawCompany ? `${rawCompany} | Pintor` : null;
            const name = rawName ? `${rawName} | Pintor` : null;
        ...
        apply({ type, value }) {
            // Update page title
            document.title = `${value} | Servicio de Pintura`;
            ...
            document.querySelectorAll('[data-dynamic]').forEach(el => {
                ...
                switch (key) {
                    ...
                    case 'footer-name':
                        ...
                        break;
                    case 'title':
                        el.textContent = `${value} | Servicio de Pintura`;
                        break;
                }
            });
        ...
        updateMeta(name) {
            ...
            if (meta) {
                meta.content = `${name} - Servicio profesional de pintor. Pintura de interiores y exteriores, garantía en todos los trabajos.`;
            }
        }
    };
